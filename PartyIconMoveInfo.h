...
public:
	...
	void SetPosition(int posX, int posZ)		{ m_cPos.posX = static_cast<WORD>(posX), m_cPos.posZ = static_cast<WORD>(posZ);	}
	void SetIconPosition(int posX, int posZ)	{ m_IconPos.posX = static_cast<WORD>(posX), m_IconPos.posZ = static_cast<WORD>(posZ);	}
