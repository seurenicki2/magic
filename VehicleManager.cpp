...
void CVehicleManager::NetworkMsgParse( BYTE Protocol, void* pMsg )
{
	...
	case MP_VEHICLE_MOUNT_REQUEST_SYN:
		{
			const MSG_DWORD4_VH* const message = ( MSG_DWORD4_VH* )pMsg;
	...
	case MP_VEHICLE_GET_OPTION_ACK:
		{
			const MSG_DWORD3_VH* const message = (MSG_DWORD3_VH*)pMsg;
...
void CVehicleManager::GetOn( DWORD dwPlayerID, DWORD dwVehicleID, DWORD dwSeatPos, DWORD dwMasterID, MONEYTYPE dwTollMoney, const char* szVehicleName, const char* szPlayerName ) const
{
