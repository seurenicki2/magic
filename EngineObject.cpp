...
void CEngineObject::EnableShadow(BOOL bShadow)
{
	...
	PTRLISTSEARCHSTART(m_AttachedWeapon,CEngineObject*,pWeapon)
		pWeapon->EnableShadow(FALSE); //disable weapon shadow johan cek
	PTRLISTSEARCHEND
...
DWORD __stdcall MHPlayerPROC(I4DyuchiGXExecutive* pExecutive, GXMAP_OBJECT_HANDLE gxh, DWORD msg, int arg1, int arg2, void* pData)
{
	...
	//Alemuri Threads------------------------------------------
	//if (arg1 % 2 == 0) //Alemuri if arg1 is even
	//{
	//	thread t1(&CEngineObject::Animate, pObject, arg1);
	//	t1.detach();
	//}
	//else
	//{
	//	thread t2(&CEngineObject::Animate, pObject, arg1);
	//	t2.detach();
	//}
	//--------------------------------------------------------
