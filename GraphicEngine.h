...
extern CObjectBase* GetSelectedObject(int MouseX,int MouseY,int PickOption , BOOL bSort);
extern CObjectBase* GetSelectedObject(PICK_GXOBJECT_DESC* pDesc, int MouseX,int MouseY,int PickOption , BOOL bSort);
