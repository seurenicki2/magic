...
public:
	CEffectUnit();
	virtual ~CEffectUnit();
	virtual void Initialize(CEffectUnitDesc*, EFFECTPARAM*);
	virtual void Release() {}
	void GetEffectStartPosition(VECTOR3* pRtPos,CObject* pObject,EFFECTPARAM*);
	...
	virtual BOOL Attach(EFFECTPARAM* pParam,char* AttachPartName,BOOL EnableScale = FALSE);
	...
	virtual void DoAttach(EFFECTPARAM* pParam,TARGETSET* pObject,char* AttachPartName,BOOL EnableScale = FALSE)	{}
