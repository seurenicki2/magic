...
public:
	...
	void InitSkillAction(cActiveSkillInfo* pSkillInfo,CActionTarget* pTarget);
	void InitSkillActionRealExecute(cActiveSkillInfo* pSkillInfo,CActionTarget* pTarget);
	...
	void Clear();
	BOOL ExcuteAction(CHero* pOperator);
	void ExcutePetAction(CHeroPet* pOperator);
