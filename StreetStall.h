...
//	cTextArea* m_pTitle;
	...
	MONEYTYPE m_MoneyArray[SLOT_STREETSTALL_NUM];
	MONEYTYPE m_TotalMoney;
...
public:
	...
	void RegistMoney();
	void RegistMoney( POSTYPE pos, MONEYTYPE dwMoney );
...
public:
	...
	MONEYTYPE GetItemMoney( POSTYPE pos ) { return m_MoneyArray[pos]; }
	...
	void ChangeItemStatus( POSTYPE pos, MONEYTYPE money, BOOL bLock );
	void ChangeItemStatus( ITEMBASE* pbase, MONEYTYPE money, BOOL bLock, int nDivideKind = 0 );
