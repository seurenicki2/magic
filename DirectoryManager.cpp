...
#define DM_INIT(mode,Directory)		strcpy(temp,root);		\
	...
	if(g_bUsingEnginePack)
	{
		...
		DM_INIT(eLM_Farm				,LDP_FARM		);
		// E ³óÀå½Ã½ºÅÛ Ãß°¡ added by hseos 2007.10.10
		DM_INIT(eLM_Housing				,LDP_HOUSING		);
	}
	else
	{
		DM_INIT(eLM_Root				,""				);
		...
		// desc_hseos_³óÀå½Ã½ºÅÛ_01
		// S ³óÀå½Ã½ºÅÛ Ãß°¡ added by hseos 2007.10.10
		DM_INIT(eLM_Farm				,LD_FARM		);
		// E ³óÀå½Ã½ºÅÛ Ãß°¡ added by hseos 2007.10.10
		DM_INIT(eLM_Housing				,LD_HOUSING		);
	}
...
char * CDirectoryManager::GetFullDirectoryName(DWORD mode)
{
	...
	BEGINLD(mode)
		...
		// desc_hseos_³óÀå½Ã½ºÅÛ_01
		// S ³óÀå½Ã½ºÅÛ Ãß°¡ added by hseos 2007.10.10
		CLD(eLM_Farm, LD_FARM)
		// E ³óÀå½Ã½ºÅÛ Ãß°¡ added by hseos 2007.10.10
		CLD(eLM_Housing, LD_HOUSING)
	ENDLD
