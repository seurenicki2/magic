...
void CStorageManager::PutInOutMoney(MONEYTYPE vals)
{	
...
void CStorageManager::PutInOutMoneyResult(MSG_DWORDEX3 * msg)
{
	if(HEROID == msg->dweData1)
	{
		HERO->SetMoney(msg->dweData2);
