...
CPWResultDlg::CPWResultDlg(void)
{
}
...
void CPWResultDlg::FillName()
{
	...
	for(TEAMSCOREINFO* pInfo = m_KillCountList.GetData();
		0 < pInfo;
...
void CPWResultDlg::SetGuildName(char* pTeam1Name, char* pTeam2Name)
{
...
void CPWResultDlg::SetKillCnt(DWORD dwPlayerID, DWORD dwCnt)
{
	if(0 == dwPlayerID)
		return;

	TEAMSCOREINFO* pInfo = m_KillCountList.GetData(dwPlayerID);
