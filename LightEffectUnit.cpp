...
void CLightEffectUnit::DoAttach(EFFECTPARAM* pParam,TARGETSET* pObject,char* AttachPartName,BOOL EnableScale/* = FALSE*/)
{
	m_pLight->AttachToObject(pObject->pTarget->GetEngineObject(),AttachPartName/*,EnableScale*/);
}
