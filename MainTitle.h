...
private:
	...
	cImageSelf* mImageBar; //use as top //johan cek
	VECTOR2 mPositionBar;
	VECTOR2 mScaleBar;
	cImageSelf* mImageBarBottom; //use as bottom //johan cek
	VECTOR2 mPositionBarBottom;
	VECTOR2 mScaleBarBottom;
	cImageSelf* mImageLogo;	
	VECTOR2 mPositionLogo;
	VECTOR2	mScaleLogo;
	cImageSelf* mImageLogoCompany;
	VECTOR2 mPositionLogoCompany;
	VECTOR2	mScaleLogoCompany;
...
public:
	...
	//Alemuri Memorize ID after Wrong Pass---------------------------------------
	void SetPreviousID(std::string prevID) {previousID = prevID; };
	//---------------------------------------------------------------------------
...
private:
	...
	void Login_Error_Overlapped_Connection();
	void AdjustBar();
