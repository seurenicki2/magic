...
cIMEex::cIMEex()
{
	...
	// 091126 ShinJS --- CheckMethod √≥∏Æ∑Œ ¿Œ«œø© ±‚∫ªπÆ¿⁄∏¶ º≥¡§«—¥Ÿ.
...
//[02-02-2012] Death Comment TL Local cause we will use Taiwan Local Support Thai Key
//#ifdef _TL_LOCAL_
...
void cIMEex::CheckAfterChange()
{
	...
	{
		// 100607 ONS ºˆ∑Æ¿‘∑¬Ω√ FOCUS∞° ª˝±‚∏È ªı∑Œ ¿‘∑¬¿ª πﬁ¥¬¥Ÿ.
		char buf[64] = {0};
		if( m_bIsFirstInput ) 
		{
