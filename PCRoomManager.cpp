	...
	case MP_PCROOM5_OPEN_MALL_ACK:
		{
			...
			SetHeroPoint( dwPCRoomPoint );
//			CHATMGR->AddMsg( CTC_SYSMSG, "Note: Dont Purchase More item Before Your VIP Point Decrease!" );
//			CHATMGR->AddMsg( CTC_OPERATOR, "Note: Dont Purchase More item Before Your VIP Point Decrease!" );
		}
		break;
	case MP_PCROOM6_OPEN_MALL_ACK:
		{
			MSG_DWORD3* pmsg = (MSG_DWORD3*)pMsg;
			if( pmsg->dwData1 != HEROID )
				break;
...
//			CHATMGR->AddMsg( CTC_OPERATOR, "Note: Dont Purchase More item Before Your VIP Point Decrease!" );
		...
		break;
	case MP_PCROOM10_OPEN_MALL_ACK:
		{
			...
			SetHeroPoint( dwPCRoomPoint );
//			CHATMGR->AddMsg( CTC_SYSMSG, "Note: Dont Purchase More item Before Your KILL Point Decrease!" );
//			CHATMGR->AddMsg( CTC_OPERATOR, "Note: Dont Purchase More item Before Your KILL Point Decrease!" );
		}
		break;
	case MP_PCROOM11_OPEN_MALL_ACK:
		{
...
//			CHATMGR->AddMsg( CTC_OPERATOR, "Note: Dont Purchase More item Before Your KILL Point Decrease!" );
	...
	case MP_PCROOM_OPEN_MALL_NACK:
		...
		break;
		//aziz multipc
	case MP_PCROOM1_OPEN_MALL_NACK:
		{
			CHATMGR->AddMsg( CTC_SYSMSG, CHATMGR->GetChatMsg( 2009 ) );
		}
		break;
	case MP_PCROOM2_OPEN_MALL_NACK:
		{
			CHATMGR->AddMsg( CTC_SYSMSG, CHATMGR->GetChatMsg( 2009 ) );
		}
		break;
	case MP_PCROOM3_OPEN_MALL_NACK:
		{
			CHATMGR->AddMsg( CTC_SYSMSG, CHATMGR->GetChatMsg( 2009 ) );
		}
		break;
	case MP_PCROOM4_OPEN_MALL_NACK:
		{
			CHATMGR->AddMsg( CTC_SYSMSG, CHATMGR->GetChatMsg( 2009 ) );
		}
		break;
	case MP_PCROOM5_OPEN_MALL_NACK:
		{
			CHATMGR->AddMsg( CTC_SYSMSG, CHATMGR->GetChatMsg( 2009 ) );
		}
		break;
	case MP_PCROOM6_OPEN_MALL_NACK:
		{
			CHATMGR->AddMsg( CTC_SYSMSG, CHATMGR->GetChatMsg( 2009 ) );
		}
		break;
	case MP_PCROOM7_OPEN_MALL_NACK:
		{
			CHATMGR->AddMsg( CTC_SYSMSG, CHATMGR->GetChatMsg( 2009 ) );
		}
		break;
	case MP_PCROOM8_OPEN_MALL_NACK:
		{
			CHATMGR->AddMsg( CTC_SYSMSG, CHATMGR->GetChatMsg( 2009 ) );
		}
		break;
	case MP_PCROOM9_OPEN_MALL_NACK:
		{
			CHATMGR->AddMsg( CTC_SYSMSG, CHATMGR->GetChatMsg( 2009 ) );
		}
		break;
	case MP_PCROOM10_OPEN_MALL_NACK:
		{
			CHATMGR->AddMsg( CTC_SYSMSG, CHATMGR->GetChatMsg( 2009 ) );
		}
		break;
	case MP_PCROOM11_OPEN_MALL_NACK:
		{
			CHATMGR->AddMsg( CTC_SYSMSG, CHATMGR->GetChatMsg( 2009 ) );
		}
		break;
